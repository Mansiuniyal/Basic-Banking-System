...
<div class="main_div">
     ...
     <div class="container">
        <div class="row">
          <div class="col-sm-6">
            ...
            <p class="big-text">Relationship Beyond Banking</p>
          </div>
          <div class="col-sm-6">
  ...
  <section class="contactus" id="contact" >
        <div class="container headings text-center">
            <h1 class="center" style="font-weight: bold;text-align: center;color:white">CONTACT US</h1>
            <p style="color:white">Any Query? Contact us we are here to help you</p>
        </div>
        <div class="container">
            <div class="row">
